...
import { FirstOrLastShadeType, ShadeType } from 'src/types'
import { Canvas } from 'src/components'

import { getNearestSafeColor } from 'src/utils'
import { DEFAULT_CANVAS_SIZE, CANVAS_HEIGHT, CANVAS_WIDTH } from 'src/constants'
